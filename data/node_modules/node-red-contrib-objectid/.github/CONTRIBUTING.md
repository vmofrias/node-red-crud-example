# Contributing to node-red-contrib-objectid

As in Node-RED we have some guidelines for the object-id contribution package.
...
At a minimum, please include:
 ...
 - Version of node-red-contrib-objectid? (should be >= 1)
